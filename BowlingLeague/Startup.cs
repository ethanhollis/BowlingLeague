...
namespace BowlingLeague
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                endpoints.MapControllerRoute("teamPageNum", "Team/{team}/{teamname}/{pageNum}", new { Controller = "Home", action = "Index" });

                endpoints.MapControllerRoute("team", "Team/{team}/{teamname}", new { Controller = "Home", action = "Index", pageNum = 1});
